    ...
    <div class="card-body login-card-body">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="input-group mb-3">
          <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autofocus placeholder="Correo Electrónico">
      ...
      -->
      <p class="mb-0">
        {{-- <ahref="route('password.update') ">Olvidé mi contraseña </a><br>--}}
